...
for l_var=1:length(landmark_t_arr)
    ...
    %% 5. Plot results and some survival prediction plots
    
    LSDSM_ALLFUNCS.plot_bs_pe_auc(pat_data_reduced, bs_test, pe_test, auc_test, landmark_t, ...
        csv_controls.censor_time, csv_controls.t_multiplier, Delta)
